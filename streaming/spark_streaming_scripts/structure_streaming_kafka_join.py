...
join_stream = clean_data.join(users, clean_data.id == users.id, "left_outer").select(clean_data.timestamp, clean_data.action, clean_data.id, users.user_name, users.user_age)
